...
MySQLSchema.prototype.validate = function(mainCallback, callback) {
  ...
  function clearErrors (fn) {
    self.errors[self.table].error = null;
    self.errors[self.table].validationErrors = {};
      ...
      self.validate(callback, function() {
        self.beforeSave(function() {
          self.beforeCreate(function() {
            ...
            for (k in self.model) {
              if (k != 'id' && self.rawSchema.hasOwnProperty(k)) {
                attributes.push(k + " = ?");
  ...
  try {
    ...
    function processUnit (unit, fn) {
      switch (unit.condition) {
        case ('='):
          if (unit.value === null || unit.value.toLowerCase() == "null") {
        ...
        case ('!='):
          if (unit.value === null || unit.value.toLowerCase() == "null") {
            conditions.push(unit.field + " IS NOT ?");
            values.push("NULL");
          } else {
            conditions.push(unit.field + " != ?");
            values.push(unit.value);
